...
function ModalComponent(props) {
  ...
  const allUsers = useSelector(state=>state.allUsersState.users)
    ...
    if(label === "mobileSearch"){
      return(
        ...
        <Container>
         ...
         {searchMob.length > 0 ? (
            <Grid item>
            <Grid container sx={{height:150  ,alignItems:"center"}}>
            <Typography sx={{color:'black' , textAlign:"center"}} >
            This section is not complete , Please be patient
            </Typography>
            </Grid>
          </Grid>
          ):null}
